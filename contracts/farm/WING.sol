...
contract WING is ERC20("WING", "WING"), Ownable {
  ...
  function transferFrom(address _sender, address _recipient, uint256 _amount) public virtual override returns (bool) {
    ...
    _approve(_sender, _msgSender(), allowance(_sender, _msgSender()).sub(_amount, "WING::transferFrom::transfer amount exceeds allowance"));
